...
import com.courseapp2.repositories.CourseRepository;
...
public class CourseService {
	...
	public Course addUserToCourse(Long courseId, Long userId) throws Exception{
		...
		emailService.sendemail(user.getUserName(), "Course Application Notification", "You have successsfully registered for "+ savedCourse.getCourseName());
		return savedCourse;
	}
